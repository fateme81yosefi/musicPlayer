        ...
        <div className="container">
            ...
            <div className="rightPage">
                ...
                <div className='row'>
                    ...
                    {currentMusic!==null && <div className="fullWidth w-full  mx-auto p-4 bg-gradient-to-br from-[#5409DA] via-[#4E71FF] to-[#BBFBFF] rounded-3xl shadow-xl flex items-center space-x-4 animate-fade-in">
