...
import { deleteAllAudioFiles } from './db/audioDB'; // مسیر درست رو تنظیم کن
...
const MainPage = () => {
    ...
    const deleteAllFiles = async () => {
        ...
        setAudioFiles([]); // رابط کاربری رو هم خالی می‌کنیم
        setCurrentMusic(null); // اگر چیزی در حال پخش بود، اونم پاک می‌شه
    };
