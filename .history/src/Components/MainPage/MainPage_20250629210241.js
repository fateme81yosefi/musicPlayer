        ...
        <div className="container">
            ...
            <div className="rightPage">
                ...
                {/* <div className='containCateg'>
                    {
                        categories.map((item, index) => (
                            <div className='categ' key={index}>
                                <img onClick={() => setSelectedCategory(item)} src={item.cover} alt='cover' />
                ...
                <div className='row'>
                    ...
                    {currentMusic !== undefined && <div className="fullWidth w-full  mx-auto p-4 bg-gradient-to-br from-[#5409DA] via-[#4E71FF] to-[#BBFBFF] rounded-3xl shadow-xl flex items-center space-x-4 animate-fade-in">
