                    ...
                    </div>
                    {
                        currentCategory !== "" ? (
                            ...
                            file.category === currentCategory ? 
                               console.log("file.category === currentCategory",file.name,file.category === currentCategory)
                             : console.log("file.category === currentCategory",file.category !== currentCategory)
                        )
                    }
